...
namespace Bai_ThucHanh.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(Bai_ThucHanhContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            return _context.User != null ?
                        ...
                        Problem("Entity set 'Bai_ThucHanhContext.User'  is null.");
        }
        ...
        public IActionResult Login(User userModel)
        {
            ...
            var user = _context.User.Where(u => u.Name == userModel.Name && u.Password == userModel.Password)
                                    .FirstOrDefault<User>();

            // Nếu người dùng không tồn tại
            if (user == null ) {
                ModelState.AddModelError("", "Tài khoản hoặc mật khẩu không đúng.");
                return View(userModel); // Có thể trả về trang login với thông báo lỗi
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Bai_ThucHanhContext.User'  is null.");
            }
            var user = await _context.User.FindAsync(id);
            if (user != null)
            {
